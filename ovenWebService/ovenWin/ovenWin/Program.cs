...
namespace ovenWin
{
    class Program
    {
        ...
        static private int TimeInterval = 1000*60, StartTime = 0, ScanTime, LimitTemp, LimitPressure;
        ...
        static void Main(string[] args)
        {
            ...
            if (args != null && args.Length > 0)
            {
                ...
                serialPort.PortName = args[0].ToString();   //for serial server the COM port connected to WISE COM3(RS-232)
        ...
        static void timer_Elapsed()
        {
            ...
            try
            {
                ...
                //Pressure 差5kg
                if (Convert.ToDouble(register_Pressure[0].ToString()) > (LimitPressure + 5)) { mail("Alan@Kuo@nxp.com", string.Format(@"The Pressure of oven exceeds the spec")); }
