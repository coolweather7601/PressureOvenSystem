<%@ Page Language="C#" MasterPageFile="~/View/Master/MasterPage.master" AutoEventWireup="true" CodeFile="RoleManage.aspx.cs" Inherits="nModBusWeb.RoleManage" Title="Role Manage" %>
...
<ContentTemplate>
        ...
        <asp:Button ID="btnImport" runat="server" Text="匯入人員" OnClick="btnImport_Click" visible="true"/>
        ...
        <asp:GridView ID="GridView1" runat="server" DataKeyNames="Oven_Assy_UsersID" AutoGenerateColumns="False" 
